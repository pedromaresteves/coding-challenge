...
describe('google search with consent form - page objects', function() {
  ...
  before(async (browser) => browser.page.google.search().navigate());
  ...
  it('should find nightwatch.js in results', function(browser) {
    ...
    homePage.acceptGdpr();
    homePage.waitForElementVisible('@searchBar')
    homePage.setValue('@searchBar', 'Nightwatch.js').click('@searchBar');
    homePage.submit();
